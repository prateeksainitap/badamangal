...
/**
 * /resources/temples directory body, extracted out of the
 * server-rendered page so the kicker / heading / body / area labels /
 * "View details" CTA / "More temples" outro all swap on the Hindi
 * toggle without a server-tree refresh.
 */
export default function TemplesView() {
