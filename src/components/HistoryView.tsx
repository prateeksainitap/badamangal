...
/**
 * /history page body, extracted out of the server-rendered page so
 * the entire chapter walk-through (kicker / hero subline / chapter
 * titles / paragraphs / pull quotes / timeline / outro CTAs) swaps to
 * Hindi the moment the LangToggle fires. The page itself stays a
 * thin server wrapper that ships static HTML + the Article JSON-LD
 * block.
 *
 * Same client-context pattern as HomeHero / HomeHistoryTeaser; here
 * we keep all of the original block renderers (Opening, Section,
 * PullQuote, Banner, Timeline, Closing) co-located so the locale
 * prop wiring stays mechanical.
 */
